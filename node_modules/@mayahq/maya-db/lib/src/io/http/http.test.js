...
var collectionSchema_1 = __importDefault(require("../mongo/collectionSchema"));
 ...
 * |--|--hcol2
 */
describe('Http I/O Client', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, collectionSchema_1.default.findOne({ path: '/httptest/col1/newcol1' })];
                case 2:
                    newcol1Doc = _a.sent();
                    expect(newcol1Doc).toBeTruthy();
                    return [4 /*yield*/, collectionSchema_1.default.findOne({ path: '/httptest/col1/newcol1/newcol2' })];
                case 3:
                    newcol2Doc = _a.sent();
    ...
    test('Deleting a block works', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, blockSchema_1.default.findOne({ path: '/httptest/col1/blockToDelete' })];
                case 2:
                    blockDoc = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, collectionSchema_1.default.findOne({ path: '/httptest/col2/newCol8' })];
                case 2:
                    newCol8 = _a.sent();
                    expect(newCol8).toBeTruthy();
                    return [4 /*yield*/, collectionSchema_1.default.findOne({ path: '/httptest/col2/newCol8/newCol9' })];
                case 3:
                    newCol9 = _a.sent();
    ...
    test('Deleting a collection works', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, collectionSchema_1.default.findOne({ path: '/httptest/colToDelete' })];
                case 2:
                    colToDelete = _a.sent();
                    expect(colToDelete).toBeFalsy();
                    return [4 /*yield*/, collectionSchema_1.default.findOne({ path: '/httptest/colToDelete/col5' })];
                case 3:
                    col5 = _a.sent();
                    expect(col5).toBeFalsy();
                    return [4 /*yield*/, blockSchema_1.default.findOne({ path: '/httptest/colToDelete/ctdBlock1' })];
                case 4:
                    ctdBlock1 = _a.sent();
                    expect(ctdBlock1).toBeFalsy();
                    return [4 /*yield*/, blockSchema_1.default.findOne({ path: '/httptest/colToDelete/ctdBlock2' })];
                case 5:
                    ctdBlock2 = _a.sent();
                    expect(ctdBlock2).toBeFalsy();
                    return [4 /*yield*/, blockSchema_1.default.findOne({ path: '/httptest/colToDelete/col5/ctdBlock3' })];
                case 6:
                    ctdBlock3 = _a.sent();
    ...
    test('Checking if collection exists works', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ioClient.includesCollection('/httptest/col1')];
                case 1:
                    i1 = _a.sent();
                    expect(i1).toBe(true);
                    return [4 /*yield*/, ioClient.includesCollection('/httptest/random')];
                case 2:
                    i2 = _a.sent();
    ...
    test('Checking if block exists works', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ioClient.includesBlock('/httptest/col1/block1')];
                case 1:
                    i1 = _a.sent();
                    expect(i1).toBe(true);
                    return [4 /*yield*/, ioClient.includesBlock('/httptest/col1/random')];
                case 2:
                    i2 = _a.sent();
                    expect(i2).toBe(false);
                    return [2 /*return*/];
    ...
    test('Reading from block works', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ioClient.readFromBlock('/httptest/col1/block1')];
                case 1:
                    data = _a.sent();
    ...
    test('Writing to block works', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    data = { b: 2 };
                    blockPath = '/httptest/col1/block2';
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, ioClient.acquireLockOnBlock('/httptest/col1/block1', function (lockDocument) { return __awaiter(void 0, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0: return [4 /*yield*/, blockSchema_1.default.findOne({ path: '/httptest/col1/block1' })];
                                                case 1:
                                                    blockDoc = _a.sent();
                ...
                case 1:
                    _a.sent();
                    t2 = Date.now();
                    return [4 /*yield*/, blockSchema_1.default.findOne({ path: '/httptest/col1/block1' })];
                case 2:
                    blockDoc = _a.sent();
    ...
    test('Ensuring hierarchy works', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, blockSchema_1.default.findOne({ path: '/httptest/hierarchyCol/hcol2/hcol3/hblock3' })];
                case 2:
                    hblock3 = _a.sent();
                    expect(hblock3).toBeTruthy();
                    return [4 /*yield*/, blockSchema_1.default.findOne({ path: '/httptest/hierarchyCol/hcol1/hblock2' })];
                case 3:
                    hblock2 = _a.sent();
                    expect(hblock2).toBeTruthy();
                    return [4 /*yield*/, collectionSchema_1.default.findOne({ path: '/httptest/hierarchyCol/hcol2/hcol3' })];
                case 4:
                    hcol3 = _a.sent();
