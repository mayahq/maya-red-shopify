...
class Tokens {
    constructor(node) {
        ...
        this.dbApiUrl = `${node.mayaBackendUrl}/v2/mayadb/db-operation`
    ...
    async get({ lock = true, cacheLimit = 45 * MINUTE } = {}) {
        ...
        try {
            ...
            const request = {
                method: 'GET',
                url: `${this.node.mayaBackendUrl}/v2/tokens`,
                headers: {
                    ...authHeaders,
    ...
    async refresh({ access_token, refresh_token }) {
        ...
        const request = {
            method: 'POST',
            url: `${this.node.mayaBackendUrl}/v2/oauth/refresh`,
            data: { 
                resource, 
                access_token, 
                refresh_token,
    ...
    lockTokens(callback) {
        return new Promise(async (resolve, reject) => {
            ...
            const lockRequest = {
                method: 'POST',
                url: `${this.node.mayaBackendUrl}/v2/tokens/lock`,
                headers: {
                    ...authHeaders,
                    profileslug: this.profileSlug
                },
            ...
            const unlockRequest = {
                method: 'POST',
                url: `${this.node.mayaBackendUrl}/v2/tokens/unlock`,
                headers: {
                    ...newAuthHeaders,
                    profileslug: this.profileSlug
                },
