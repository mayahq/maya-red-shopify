...
class SelectField extends Field {
    constructor({
        ...
        this.optionNameMap = optionNameMap
    ...
    onEditPrepareCode(name, schema) {
        ...
        return dedent(`
            ...
            const nameMap = ${JSON.stringify(this.optionNameMap)}
            ${name}FieldSetNames.forEach((fieldSetName) => {
                $("#${prefix}-${name}").append($("<option></option>").attr("value", fieldSetName).text(nameMap[fieldSetName] ? nameMap[fieldSetName] : fieldSetName))
            })
